	...
	<div class="row">
		<div class="col-md-2 col-sm-4">
			<div class="account-picture-block text-center">
				...
				<!-- IF email -->
				<!-- IF isSelf -->
				<!--<a id="confirm-email" href="#" class="btn btn-warning &lt;!&ndash; IF email:confirmed &ndash;&gt;hide&lt;!&ndash; ENDIF email:confirmed &ndash;&gt;">[[user:confirm_email]]</a><br/><br/>-->
				<!-- ENDIF isSelf -->
				<!-- ENDIF email -->
						...
						<!--<div class="form-group">-->
							...
							<!--<div class="controls">-->
								<!--<select class="form-control" id="groupTitle" data-property="groupTitle">-->
									...
									<!--&lt;!&ndash; BEGIN groups &ndash;&gt;-->
									<!--&lt;!&ndash; IF groups.userTitleEnabled &ndash;&gt;-->
									<!--<option value="{groups.name}" &lt;!&ndash; IF groups.selected &ndash;&gt;selected&lt;!&ndash; ENDIF groups.selected &ndash;&gt;>{groups.userTitle}</option>-->
									<!--&lt;!&ndash; ENDIF groups.userTitleEnabled &ndash;&gt;-->
									<!--&lt;!&ndash; END groups &ndash;&gt;-->
								<!--</select>-->
							<!--</div>-->
						<!--</div>-->
